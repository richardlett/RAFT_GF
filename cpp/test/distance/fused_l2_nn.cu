...
// diff size k
  ...
  {0.001f, 64, 128, 128,16*30, 12345ULL},
    ...
    // diff size k
  {0.001f, 32+32*32, 32, 32, 16*30, 12346ULL},
  {0.001f, 32, 64, 16*30, 48,  12345ULL},
  {0.001f, 64, 32, 32, 16*30,  12345ULL},
  {0.001f, 4001, 2332, 16*30,16*30,  12345ULL},
  {0.001f, 32+32*32, 32+32*32, 16*30, 48, 12345ULL},
  {0.001f, 32334, 64, 32,48, 12345ULL},
  {0.001f, 1225, 128, 64, 48, 12345ULL},
  {0.001f, 6334, 128, 128,16*30, 12345ULL},
};
